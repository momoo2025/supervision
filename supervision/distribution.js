...
const DISTRIBUTION_ZONES = new Set(["Circuit secondaire", "Ligne liquide", "Zone stockage"]);
...
const distributionData = data.filter((eq) => DISTRIBUTION_ZONES.has(eq.zone));
const points = distributionData.length > 0 ? distributionData : data;
